...
export default function SkillSheet({ highlight }) {
  return (
    <div
      className="relative block p-3 text-white text-serif text-2xl font-semibold rounded"
      style={{
        height: "23.5rem",
        width: "59%",
        position: "absolute",
        ...
        borderRadius: "5px",
        boxShadow: "0 0 5px purple, 0 0 5px purple",
      }}>
      <div className="flex flex-col items-start mb-2">
        <div className="flex items-end">
          {/* Container for the number and line */}
          <div className="flex flex-col items-center" style={{ marginLeft: "-4px" }}>
            <span className="text-white text-m" style={{ marginRight: "0px", marginBottom: "-4px" }}>
              +2
            </span>{" "}
            {/* Adjust with your dynamic number */}
          ...
          <div className={highlight?.toLocaleLowerCase() === "acrobatics" ? "highlight-container" : ""}>
            <div className="text-white text-sm" style={{ marginBottom: "1px", marginLeft: "6px" }}>
              Acrobatics
            </div>
          </div>
